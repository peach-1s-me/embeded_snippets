...
static cat_i32 _itoa(char *buf, cat_i32 num);
static cat_i32 _itoh(char *buf, cat_u32 num);
        ...
        if (*format == '%')
        {
            ...
            switch (*format)
            {
                case 'd':
                {
                    ...
                    /* 将i32转换为字符串 */
                    num_strlen = _itoa(num_str_buffer, num);
                ...
                case 'x':
                {
                    ...
                    /* 将i32转换为字符串 */
                    num_strlen = _itoh(num_str_buffer, num);
                    need_print_and_move = CAT_TRUE;
        ...
        if (*format == '%')
        {
            ...
            switch (*format)
            {
                case 'd':
                {
                    ...
                    /* 将i32转换为字符串 */
                    out_str_len = _itoa(out_str_buf, num);
                    need_print_and_move = CAT_TRUE;
                ...
                case 'x':
                {
                    ...
                    /* 将i32转换为字符串 */
                    out_str_len = _itoh(out_str_buf, num);
                    need_print_and_move = CAT_TRUE;
